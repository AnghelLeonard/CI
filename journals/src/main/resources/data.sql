INSERT INTO user(login_name, pwd, email, enabled, role) VALUES ('publisher1', '$2a$10$RC1.YFSL8o2vCIg6kB3fjuBB639BdjY6AD8rIw9oyWJLws/1Q6Lku', 'publisher1@yahoo.com', TRUE, 'PUBLISHER');
INSERT INTO user(login_name, pwd, email, enabled, role) VALUES ('publisher2', '$2a$10$MUahUza86ErCxtsgpmMBDeR5VtoGHioRdl03/jQmkM/sk6L.Eg28e', 'publisher2@yahoo.com', TRUE, 'PUBLISHER');
INSERT INTO user(login_name, pwd, email, enabled, role) VALUES ('user1', '$2a$10$WcgRF8VQ8DKt4h4Hz9pWv.6MXnIRmcPr0j9jqsseprsBwTD4w8WSm', 'user1@yahoo.com', TRUE, 'USER');
INSERT INTO user(login_name, pwd, email, enabled, role) VALUES ('user2', '$2a$10$Q5bxyPXhHXFc1fRUMCRWR.GbgsXx9aGZdoEoEAz2JFEfckdyUKfOi', 'user2@yahoo.com', TRUE, 'USER');
