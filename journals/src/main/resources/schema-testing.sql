...
create table user (id bigint generated by default as identity (start with 1), enabled boolean not null, login_name varchar(255) not null, pwd varchar(255) not null, email varchar(255) not null, role varchar(255) not null, primary key (id));
